...
public class SplashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Tween Animation
        //Locating the image on the xml
        ImageView imgRotate = (ImageView) findViewById(R.id.imageViewLoading);

        //when the activity opens the image will start moving as animation
